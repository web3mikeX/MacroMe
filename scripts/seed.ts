...
const SAMPLE_RECIPES = [
  {
    ...
    steps: [
      ...
      {
        order: 2,
        text: 'Season chicken breast with salt, pepper, and herbs',
        time_s: 120,
      },
      {
        order: 3,
        text: 'Wash and cube sweet potato into 1-inch pieces',
        time_s: 180,
      },
      {
        order: 4,
        text: 'Place sweet potato cubes in microwave-safe dish with 2 tbsp water',
        time_s: 60,
      },
      {
        order: 5,
        text: 'Microwave sweet potato on high for 5-6 minutes until tender',
        time_s: 360,
      },
      {
        order: 6,
        text: 'Cut broccoli into florets and steam for 4-5 minutes',
        time_s: 300,
      },
      {
        order: 7,
        text: 'Grill chicken breast for 6-7 minutes per side until internal temp reaches 165°F',
        time_s: 840,
      },
      {
        order: 8,
        text: 'Let chicken rest for 5 minutes, then slice',
        time_s: 300,
      },
      {
        order: 9,
        text: 'Drizzle vegetables with olive oil and serve with chicken',
        time_s: 60,
      },
    ],
    ingredients: [
  ...
  },
  {
    ...
    steps: [
      {
        order: 1,
        text: 'Rinse quinoa in fine mesh strainer until water runs clear',
        time_s: 120,
      },
      {
        order: 2,
        text: 'Cook quinoa: 1 cup quinoa to 2 cups water, bring to boil then simmer covered for 15 minutes',
        time_s: 900,
      },
      {
        order: 3,
        text: 'Mix honey, minced garlic, soy sauce, and ginger for marinade',
        time_s: 180,
      },
      {
        order: 4,
        text: 'Marinate salmon fillets for 15 minutes (or longer)',
        time_s: 900,
      },
      {
        order: 5,
        text: 'Heat olive oil in a pan over medium-high heat',
        time_s: 120,
      },
      {
        order: 6,
        text: 'Cook salmon skin-side up for 4 minutes without moving',
        time_s: 240,
      },
      {
        order: 7,
        text: 'Flip salmon and cook for another 3-4 minutes until flaky',
        time_s: 210,
      },
      {
        order: 8,
        text: 'Fluff quinoa with a fork and serve with salmon',
        time_s: 120,
      },
    ],
    ingredients: [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        order: 2,
        text: 'Wash and slice avocado into thin slices',
        time_s: 120,
      },
  ...
  },
  {
    ...
    steps: [
      {
        order: 1,
        text: 'Rinse brown rice until water runs clear',
        time_s: 120,
      },
      {
        order: 2,
        text: 'Cook brown rice: 1 cup rice to 2.5 cups water, bring to boil then simmer covered for 45 minutes',
        time_s: 2700,
      },
      {
        order: 3,
        text: 'Steam broccoli florets for 4-5 minutes until tender-crisp',
        time_s: 300,
      },
      {
        order: 4,
        text: 'Sauté baby spinach with a little olive oil for 2 minutes',
        time_s: 120,
      },
      {
        order: 5,
        text: 'Fluff rice with fork and serve topped with vegetables',
        time_s: 120,
      },
    ],
    ingredients: [
  ...
  },
  {
    ...
    steps: [
      {
        order: 1,
        text: 'Cook quinoa according to package directions and let cool',
        time_s: 1200,
      },
      ...
      {
        order: 4,
        text: 'Combine quinoa, spinach, and avocado in a large bowl',
        time_s: 60,
      },
      {
        order: 5,
        text: 'Whisk olive oil with lemon juice for simple dressing',
        time_s: 60,
      },
      {
        order: 6,
        text: 'Toss salad with dressing and serve immediately',
        time_s: 60,
      },
    ],
    ingredients: [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        order: 2,
        text: 'Season chicken breast with herbs and place in baking dish',
        time_s: 180,
      },
      { order: 3, text: 'Peel and cube sweet potatoes', time_s: 300 },
      {
        order: 4,
        text: 'Boil sweet potato cubes for 15-20 minutes until tender',
        time_s: 1200,
      },
      {
        order: 5,
        text: 'Bake chicken for 25-30 minutes until internal temp reaches 165°F',
        time_s: 1800,
      },
      {
        order: 6,
        text: 'Drain sweet potatoes and mash with a little olive oil',
        time_s: 180,
      },
      {
        order: 7,
        text: 'Steam broccoli for the last 5 minutes of chicken cooking time',
        time_s: 300,
      },
      {
        order: 8,
        text: 'Let chicken rest 5 minutes before serving with mashed sweet potato and broccoli',
        time_s: 300,
      },
    ],
    ingredients: [
 ...
 */
async function seedRecipes(ingredients: unknown[]) {
  ...
  for (const recipeData of SAMPLE_RECIPES) {
    ...
    if (recipeError) {
      console.error(
        `❌ Failed to seed recipe "${recipeData.name}":`,
        recipeError
      )
      continue
    }
    ...
    const recipeIngredients = recipeData.ingredients
      .map((ing) => {
        ...
        if (!ingredient) {
          console.warn(
            `⚠️ Ingredient "${ing.name}" not found for recipe "${recipeData.name}"`
          )
          return null
        }
    ...
    if (recipeIngredients.length > 0) {
      ...
      if (ingredientsError) {
        console.error(
          `❌ Failed to seed ingredients for recipe "${recipeData.name}":`,
          ingredientsError
        )
      }
    }
 ...
 */
async function seedDemoUser(ingredients: unknown[]) {
  ...
  const pantryItems = DEMO_PANTRY.map((pantryItem) => {
    ...
    if (!ingredient) {
      console.warn(
        `⚠️ Ingredient "${pantryItem.ingredient}" not found for pantry`
      )
      return null
    }
...
async function main() {
  try {
    ...
    // Create demo user and populate pantry
    await seedDemoUser(ingredients)
    ...
    console.log(
      `   • Macro targets: ${DEMO_USER.profile.kcal_target} kcal (${DEMO_USER.profile.protein_pct}P/${DEMO_USER.profile.carb_pct}C/${DEMO_USER.profile.fat_pct}F)`
    )
  } catch (error) {
